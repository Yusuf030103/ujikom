...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysqli_query($koneksi,"UPDATE siswa SET nama='$nama', idprodi='$idprodi', kelas='$kelas' WHERE nis='$nis'");
		...
		list($nis,$nama,$idprodi,$kelas) = mysqli_fetch_array($sql);
?>
...
<form method="post" action="admin.php?hlm=master&sub=siswa&aksi=edit" class="form-horizontal" role="form">
	...
	<div class="form-group">
		...
		<select class="form-control" name="kelas" required>
		  <option hidden=""><?php echo $kelas; ?></option>
