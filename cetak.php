...
<?php
   ...
   list($nis,$nama,$idprodi,$kelas) = mysqli_fetch_array($qsiswa);
   ...
   echo '<tr><td colspan="2">Nama Siswa</td><td colspan="3">'.$kelas.'</td></tr>';
   echo '<tr class="info"><th width="50">#</th>><th>Bulan</th><th>Tanggal Bayar</th><th>Jumlah</th>';
   echo '</tr>';
